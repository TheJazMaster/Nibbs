...
public interface IDynaCharge
{
	...
	void Render(G g, State state, Combat combat, Ship ship, int worldX, Vec position) => ModEntry.Instance.DynaApi?.DefaultRenderChargeImplementation(this, g, state, combat, ship, worldX, position);
